...
export class MetricsService {
  ...
  constructor() {
    ...
    this.transferAmountTotal = new client.Counter({
      name: 'teller_transfer_amount_total',
      help: 'Total transfer amount in THB',
      labelNames: ['currency'],
      registers: [this.register],
    });

    this.accountCreatedTotal = new client.Counter({
      name: 'teller_account_created_total',
      help: 'Total accounts created',
      registers: [this.register],
    });

    this.transactionsTotal = new client.Counter({
      name: 'teller_transactions_total',
    ...
    this.reconciliationTotal = new client.Counter({
      name: 'teller_reconciliation_total',
